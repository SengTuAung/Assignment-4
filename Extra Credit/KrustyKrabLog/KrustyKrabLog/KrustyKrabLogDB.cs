...
namespace KrustyKrabLog
{
    public class KrustyKrabLogDB
    {
        ...
        /// <summary>
        /////4-27-2021 Saung NEW 5L :  Constructor Fet all Information from database
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        //4-27-2021 Saung NEW 5L :  Constructorinsert Information
        /// </summary>
        /// <param name="id"></param>
        ...
        /// <summary>
        ///4-27-2021 Saung NEW 5L :  Constructor Update Information
        /// </summary>
        /// <param name="id"></param>
        /// <param name="date"></param>
        /// <param name="name"></param>
